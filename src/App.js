...
// ab vapis switch back nhi hoga starting vale pr jgh change krege toh 
    ...
    setloading(true)
     Getplacesdata(type, bounds.sw, bounds.ne)
      .then((data) => {
        ...
        setplaces(data?.filter((nonemptyplace)=>nonemptyplace.name && nonemptyplace.num_reviews>0 && nonemptyplace.photo ) );
  ...
  <GlobalContext.Provider value={{receivekrega,sendkrega,type,settype,ratekro,setrating}}>
   <>
